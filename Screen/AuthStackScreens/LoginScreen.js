...
const LoginScreen = ({navigation}) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={[styles.lefttext, {top: 223}]}>이메일</Text>
      <FocusableInput
        style={[styles.Input, {top: 246}]}
        onChangeText={userEmail => {
          setUserEmail(userEmail);
          checkButtonStatus();
        }}
      />
      <Text style={[styles.lefttext, {top: 306}]}>비밀번호</Text>
      ...
      <TouchableOpacity
        ...
        style={[
          styles.touchbox,
          {top: 412, backgroundColor: isButtonActive ? '#3BCDA1' : '#CECECE'},
        ]}
      ...
      <TouchableOpacity
        ...
        <Text
          style={[styles.PretendardRegular, {fontSize: 16, color: '#000000'}]}>
          회원가입
        </Text>
      </TouchableOpacity>
      <TouchableOpacity
      ...
      <TouchableOpacity
        ...
        <View style={styles.innerContainer}>
          ...
          />
          <Text
            style={[styles.PretendardBold, {fontSize: 16, color: '#000000'}]}>
            카카오 로그인
          </Text>
        </View>
      </TouchableOpacity>
